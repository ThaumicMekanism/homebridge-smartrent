...
<h1>
  <a href="https://github.com/ThaumicMekanism/homebridge-smartrent">
...
[![npm version](https://badgen.net/npm/v/@thaumictech/homebridge-smartrent?color=purple&icon=npm&label)](https://www.npmjs.com/package/@thaumictech/homebridge-smartrent)
[![npm downloads](https://badgen.net/github/last-commit/ThaumicMekanism/homebridge-smartrent?color=cyan&icon=github)](https://github.com/ThaumicMekanism/homebridge-smartrent)
[![npm version](https://badgen.net/github/stars/ThaumicMekanism/homebridge-smartrent?color=cyan&icon=github)](https://github.com/ThaumicMekanism/homebridge-smartrent)
[![GitHub pull requests](https://img.shields.io/github/issues-pr/ThaumicMekanism/homebridge-smartrent.svg)](https://github.com/ThaumicMekanism/homebridge-smartrent/pulls)
[![GitHub issues](https://img.shields.io/github/issues/ThaumicMekanism/homebridge-smartrent.svg)](https://github.com/ThaumicMekanism/homebridge-smartrent/issues)
...
1. Install the plugin using NPM:
   ...
   ```sh
   npm i -g @thaumictech/homebridge-smartrent
   ```
